...
$username=$_SESSION['alogin'];
    $sql ="SELECT Password FROM science WHERE UserName=:username and Password=:password";
...
if($query -> rowCount() > 0)
{
$con="update science set Password=:newpassword where UserName=:username";
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
            							<li><a href="dashboard - Sci.php"><i class="fa fa-home"></i> Home</a></li>
