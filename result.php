                ...
                <div class="content-container">
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div" style="background-color:#000;">
                                <div class="col-md-12">
                                    <h2 class="title" align="center" 
    style ="color: #fff;"
>Online Statement of Marks</h2>
                                </div>
                            </div>
                            <!-- /.row -->
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h3 align="center">Dattajirao kadam Arts, Science and Commerce College, Ichalkaranji</h3>
                                                    <hr />
<?php
// code Student Data
$rollid=$_POST['rollid'];
...
{   ?>
<p><b>Name &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp; <?php echo htmlentities($row->StudentName);?></b></p>
...
<td style="text-align: center"><b><?php echo number_format($totlcount * 100 / $outof, 2); ?> %</b></td>
</tr>
