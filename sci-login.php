...
$sql ="SELECT UserName,Password FROM science WHERE UserName=:uname and Password=:password";
...
echo "<script type='text/javascript'> document.location = 'dashboard - sci.php'; </script>";
} else{
...
<div class="container">
       <div class="box">
        <div class="header">
            ...
            <p>Welcome To Science Department</p>
        </div>
		<form  method="post">
        <div class="input-box">
