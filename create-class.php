...
$sql="INSERT INTO  tblclasses(ClassName,DepartmentId,ClassNameNumeric,Section) VALUES(:classname,:department,:classnamenumeric,:section)";
$query = $dbh->prepare($sql);
$query->bindParam(':classname',$classname,PDO::PARAM_STR);
$query->bindParam(':department',$class,PDO::PARAM_STR);
...
<html lang="en">
    <head>
        ...
        <title> Dkasc | Create Class</title>
                                        ...
                                        <?php } ?>
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class="form-group has-success">
                                                        ...
                                                        <div class=" ">
 <select name="department" class="form-control" id="success" required="required">
