...
$username=$_SESSION['alogin'];
    $sql ="SELECT Password FROM arts WHERE UserName=:username and Password=:password";
...
if($query -> rowCount() > 0)
{
$con="update arts set Password=:newpassword where UserName=:username";
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
            							<li><a href="dashboard - arts.php"><i class="fa fa-home"></i> Home</a></li>
