...
$username=$_SESSION['alogin'];
    $sql ="SELECT Password FROM commerce WHERE UserName=:username and Password=:password";
...
if($query -> rowCount() > 0)
{
$con="update commerce set Password=:newpassword where UserName=:username";
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
            							<li><a href="dashboard - Com.php"><i class="fa fa-home"></i> Home</a></li>
