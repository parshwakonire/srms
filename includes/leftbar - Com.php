<div class="left-sidebar bg-300 box-shadow "style="background:#FFFFFF;">
                        <div class="sidebar-content">
                            <div class="user-info ">
                                <img src="images\person-circle.svg" width="40" height="40" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
                                <h6 class="title">HOD.Commerce</h6>
                                <small class="info">Sub-Administrator</small>
                            </div>
                            <!-- /.user-info -->

                            <div class="sidebar-nav">
                                <ul class="side-nav "style="color:#000; font-weight: 700;">
                                    <li class="nav-header">
                                        <span class="">Main Category</span>
                                    </li>
                                    <li>
                                        <a href="dashboard - Com.php"><i class="fa fa-dashboard"></i> <span>Dashboard</span> </a>
  ...
  <li class="has-children">
   ...
   <!-- <li class="has-children">
                                        ...
                                        <ul class="child-nav">
                                            ...
                                            <li><a href="manage-students.php"><i class="fa fa fa-server"></i> <span>Students info</span></a></li>
...
<li class="has-children">
                                        ...
                                        <ul class="child-nav">
                                            <li><a href="add-result-com.php"><i class="fa fa-bars"></i> <span>Add Result</span></a></li>
                                            <li><a href="manage-results - com.php"><i class="fa fa fa-server"></i> <span>Manage Result</span></a></li>
 ...
 <!-- <li class="has-children">
                                        ...
                                        <li><a href="change-password - Com.php"><i class="fa fa fa-server"></i><span>Change Password</span></a></li>
                                        <!-- <li><a href="creat-login.php"><i class="fa fa fa-server"></i> <span> Manage Faculty Login </span></a></li> -->
