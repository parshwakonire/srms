                        ...
                        <div class="sidebar-content">
                            ...
                            <div class="sidebar-nav">
                                <ul class="side-nav "style="color:#000; font-weight: 700;">
                                    ...
                                    <li>
                                        <a href="dashboard - Sci.php"><i class="fa fa-dashboard"></i> <span>Dashboard</span> </a>
...
<li class="has-children">
                                        ...
                                        <ul class="child-nav">
                                            <li><a href="add-result-sci.php"><i class="fa fa-bars"></i> <span>Add Result</span></a></li>
                                            <li><a href="manage-results - sci.php"><i class="fa fa fa-server"></i> <span>Manage Result</span></a></li>
...
<!-- <li class="has-children">
                                        ...
                                        <li><a href="change-password - Sci.php"><i class="fa fa fa-server"></i><span>Change Password</span></a></li>
